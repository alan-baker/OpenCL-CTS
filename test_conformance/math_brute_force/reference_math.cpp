...
double reference_relaxed_atan( double x )
{
    return reference_atan( x );
}
...
double reference_relaxed_acos(double x)
{
  return reference_acos(x);
}
...
double reference_relaxed_asin(double x)
{
    return reference_asin( x );
}
